...
export default function Edit({ auth, pengadaan, laboratories }) {
    const { data, setData, put, processing, errors } = useForm({
        item_name: pengadaan.item_name,
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('pengadaan.update', pengadaan.id));
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Pengadaan</h2>}
        >
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <form onSubmit={handleSubmit} className="p-6">
                            {/* Form fields identical to Create.jsx */}
